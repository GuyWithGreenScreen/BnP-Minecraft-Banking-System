...
The Minecraft server must have the [NeoForge mod](mod/build/libs/minecrafteconomy-1.0.jar) installed, as well as, the config file of the mod must contain an API key that you generate using the [supplementary.py](code/supplementary.py) program, simply by calling the 
