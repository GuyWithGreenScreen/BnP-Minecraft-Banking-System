...
import dev.gwgs.minecrafteconomy.commands.MCE_Create_ChequeCommand;
...
public class Cheque extends Item {
    ...
    public Component getName(ItemStack stack) {
        return Component.literal("Cheque").withStyle(ChatFormatting.BLUE);
    }
    ...
    public static ItemStack returnSelf(String ID, int currency_type, String currency_name, String currency_id, String from_user_ID, String to_user_ID, String from_user_name, String to_user_name, int amount) {
        ItemStack returnItemStack = new ItemStack(MCE_Items.CHEQUE.asItem(), 1);
    ...
    public void appendHoverText(ItemStack p_41421_, TooltipContext p_339594_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        p_41423_.add(Component.literal("CHEQUE ID: " + p_41421_.get(MCEDataComponentTypes.CHEQUE_INVOICE_ID)).withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
